...
// PatternMatcher implements high-performance Graphite metric filtering
...
func (p *PatternMatcher) InitPatterns(allowedPatterns []string) {
	p.AllowedPatterns = allowedPatterns
}

// DetectMatchingPatterns returns a list of allowed patterns that match given metric
func (p *PatternMatcher) DetectMatchingPatterns(metricName string) (matchingPatterns []string) {
